...
namespace MassTransit.Transports.Msmq.Tests
{
		...
		MsmqEndpointOnlyTestFixture
	{
		...
		public void Reading_a_single_message_with_long_type_name_should_return_one_message_selector()
		{
			...
			Endpoint.Receive(context =>
				{
					IConsumeContext<SomeReallyLongNamespaceA.SomeReallyLongNamespaceB.SomeReallyLongNamespaceC.SomeReallyLongNamespaceD.SomeReallyLongNamespaceE.SomeReallyLongNamespaceF.SomeReallyLongNamespaceG.SomeReallyLongNamespaceH.SomeReallyLongNamespaceI.A> pingContext;
					context.TryGetContext(out pingContext).ShouldBeTrue();
